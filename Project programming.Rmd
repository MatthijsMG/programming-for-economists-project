...
dataset_berekend <- dataset_samengevoegd %>%
  mutate(
    ...
    # 2. Berekening totale gaskosten (met de originele CBS-namen)
    ...
    # 3. Berekening totale stroomkosten (met de originele CBS-namen)
    ...
    # 4. Totale energiekosten gecombineerd
    total_energy_costs = gas_costs + electricity_costs,
    
    # 5. Berekening energy_burden (totale energiekosten)
    energy_burden = (total_energy_costs / (income_median * 1000)) * 100,
    
    # 6. Berekening gas_burden (pure gaskosten)
    gas_burden = (gas_costs / (income_median * 1000)) * 100,
    
    # 7. Berekening electricity_burden (pure stroomkosten)
